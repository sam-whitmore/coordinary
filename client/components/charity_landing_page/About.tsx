...
export default function About() {
  ...
  return (
    <div className="relative h-full w-5/6 overflow-y-scroll">
      ...
      <div className="fixed h-1/2 w-full bg-gradient-to-b from-transparent from-80% to-white"></div>
      <div className="absolute left-0 top-[45%] mx-[5%] h-auto w-[90%] rounded-2xl bg-slate-100 p-6 shadow-lg">
        <h1 className="mb-4 text-5xl font-medium font-wix-display text-primary capitalize">About {charity.name}</h1>
        <h2 className="mb-2 mt-6 text-3xl font-medium font-wix-display text-primary">Our Vision</h2>
        <p>
          <em>*insert vision statement here (with passed-props)*</em>
        </p>
        <h2 className="mb-2 mt-6 text-3xl font-medium font-wix-display text-primary">Our Mission</h2>
        <p>
          <em>*insert mission statement here (with passed-props)*</em>
        </p>
        <h2 className="mb-2 mt-6 text-3xl font-medium font-wix-display text-primary">Our Values</h2>
        ...
        <h2 className="mb-2 mt-6 text-3xl font-medium font-wix-display text-primary">Our Services</h2>
        <p>
          <em>
        ...
        <h2 className="mb-2 mt-6 text-3xl font-medium font-wix-display text-primary">Our Story</h2>
        <p className="pb-2">
        ...
        <h3 className="my-6 text-center text-2xl font-semibold font-wix-display text-primary">
